...
<%@ include file="/js/tools/userManage/shopStatus.js"%>
		...
		<div class="span12">
			...
			<form name="sunday">
				...
				<select name="startTime" onchange="postOperationHours('sunday')">
					<%@ include file="/tools/userManage/common/operationStartTime.jsp"%>
				</select>
				<p>営業終了時間</p>
				<select name="endTime" onchange="postOperationHours('sunday')">
					<%@ include file="/tools/userManage/common/operationEndTime.jsp"%>
				</select>
			</form>
