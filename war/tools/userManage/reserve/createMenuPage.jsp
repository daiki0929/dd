...
<body>
   ...
   <div class="span12">
   <h3>メニューページ作成</h3>
   	<form action="/tools/userManage/reserve/DoneCreateMenuPage" method="post">
   	<p>メニューページのタイトル</p>
   	...
   	<p>予約形態</p>
   	<label class="radio">
	  <input type="radio" name="reserveSystem" value="firstArrival" checked>
	  先着順
	</label>
	<label class="radio">
	  <input type="radio" name="reserveSystem" value="recognition">
	  承認制
	</label>
   	<p>公開設定</p>
   	<label class="radio">
	...
	<label class="radio">
	  <input type="radio" name="status" value="not_open">
	  非公開
	</label>
   	<p>予約受け付け期間</p>
