...
(function() {
  ...
  $.fn.sieve = function(options) {
    ...
    return this.each(function() {
      ...
      settings = $.extend({
        searchInput: null,
        searchTemplate: '<div style="margin:20px 0 10px 0;"><div class="input-prepend"><label><span class="add-on"><i class="icon-search "></i></span><input class="" id="prependedInput" type="text" placeholder="Search..."></label></div></div>',
