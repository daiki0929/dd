...
//    "https://www.googleapis.com/auth/drive", // Google Drive
    ...
    public String getRedirectUri(HttpServletRequest req) {
        ...
        genericUrl.setRawPath("/tools/rese/comeAndGo/google/callBack");
     ...
     * @throws IOException
     */
    public GoogleAuthorizationCodeFlow callbackFlow() throws IOException {
        try {
     ...
     * @return
     */
    public Userinfoplus getUserInfo(GoogleCredential credentials) {
     ...
     * @throws IOException
     */
    public void sendMessage(MsUser msUser, String to, String bcc, String subject, String content) throws GeneralSecurityException, IOException {
...
//            email.setFrom(new InternetAddress(from.getGmailAddress()));
     ...
     * @return
     */
    public MsUser getSameMsUser(String mailAddress) {
