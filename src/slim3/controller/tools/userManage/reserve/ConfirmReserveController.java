...
public class ConfirmReserveController extends AbstractController {
    ...
    public Navigation run() throws Exception {
        ...
        if (errors.size() != 0) {
            ...
            return forward("/tools/userManage/reserve/timeschedule.jsp");
        }
...
//        log.info("予約開始：" + reserveDateTime.toString());
        int menuTimeInt = Integer.parseInt(orderMenu.getTime());
//        log.info("メニューの時間：" + Integer.toString(menuTimeInt/60) + "分");
        //メニュー終了時刻
        DateTime menuEndTime = reserveDateTime.plusMinutes(menuTimeInt/30);
